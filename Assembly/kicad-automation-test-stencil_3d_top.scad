// Generated by SolidPython <Unknown> on 2023-02-10 23:29:02
$fa = 0.4; $fs = 0.4;
...
rotate(a = 180, v = [1, 0, 0]) {
	difference() {
			...
			difference() {
				linear_extrude(height = 1.4500000000) {
					offset(r = 1.0000000000) {
						import(file = "kicad-automation-test-stencil_3d_edge.dxf", origin = [0, 0]);
					}
				}
		...
		linear_extrude(center = true, height = 0.6000000000) {
			translate(v = [0, 0, 0]) {
				import(file = "kicad-automation-test-stencil_3d_top.dxf", origin = [0, 0]);
			}
		}
	}
}
